...
let map = L.map('mapid', {center: [44.0, -80.0], zoom: 2,layers:[dark]}) ;
...
L.geoJson(data, {
  color: "#FFFC66",weight: 2, opacity: 0.5,
  // Wet turn each feature into a marker on the map
  onEachFeature: function(feature,layer) {
    layer.bindPopup("<h3>" + "Airline:" + feature.properties.airline + "<hr><br>Destination:" + feature.properties.dst);
  }
}).addTo(map);
})
